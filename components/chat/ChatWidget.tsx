        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-50 inset-4 md:inset-auto md:bottom-24 md:right-6
                       md:w-[380px] md:h-[600px] md:max-h-[80vh]
                       flex flex-col bg-black rounded-2xl overflow-hidden
            ...
            >
              ...
              <div  data-lenis-prevent className="flex-1 overflow-y-auto overscroll-contain p-4">
                <div data-lenis-prevent className="flex flex-col gap-3">
