...
export default function AnimatedCharacters() {
    ...
    return (
        <>
            <div className="relative p-12 text-primary-foreground flex justify-center items-center h-full w-full overflow-hidden">

                <div className="relative z-20 flex items-end justify-center h-auto">
                    {/* Cartoon Characters */}
                    <div className="relative" style={{ width: '550px', height: 'auto' }}>
