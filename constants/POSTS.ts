...
//     description: "During West Side Fest",
...
export const CARDS_POSTS: POSTS[] = [
  {
    ...
    title: "A REIMAGINED WEST 14TH STREET",
    slug: "a-reimagined-west-14th-street",
    description: "This spring, a more dynamic, pedestrian-centered West 14th Street debuted between Ninth and Tenth Avenues.",
    content: `This spring, a more dynamic, pedestrian-centered West 14th Street debuted between Ninth and Tenth Avenues in the Meatpacking District. The West 14th Street Promenade created a "third space" for community enjoyment while enhancing connections to Hudson River Park and enlivening the retail corridor.

Through the repurposing of the curblane and transformation of the wide, two-way underutilized roadbed along West 14th Street between Ninth and Tenth Avenues, locals and visitors alike now get to experience five new gathering areas, lush landscaping, and in the future, opportunities for public art and small concessions.

The Meatpacking District Management Association (Meatpacking BID) led the project in partnership with design partners Street Plans and TYLin.`,
    author: "Meatpacking BID",
    publishedDate: "07.01.2025",
  ...
  },
  {
    ...
    title: "Step Into Hopper",
    slug: "step-into-hopper",
    description: "An immersive experience bringing 3-D recreations of Edward Hopper's paintings to life.",
    content: `STEP INTO HOPPER
In partnership with the Whitney Museum, we invite you to an immersive experience and to "Step into Hopper." This program brings 3-D recreations of Edward Hopper's paintings to life, designed for today's visitors by Theresa Rivera Design.

From July 11 - 13, in celebration of West Side Fest and Hopper's 143rd birthday, you can explore life-size recreations of his iconic works: Nighthawks, Soir Bleu, and Early Sunday Morning.

• Nighthawks - Take a seat inside Hopper's iconic diner scene.
• Soir Bleu - Transporting visitors into Hopper's introspective take on French café culture.
• Early Sunday Morning - Step off the bustling streets of present-day New York City and into the stillness of this portrait of Seventh Avenue in the 1930s.`,
    author: "Whitney Museum",
    publishedDate: "06.25.2025",
  ...
  },
  {
    ...
    socialHandle: "@MeatpackingNY",
    slug: "summer-solstice-party",
    description: "The biggest party of the summer is back.",
    author: "Meatpacking BID",
    publishedDate: "06.25.2025",
    // Replace with local image
  ...
  },
  {
    ...
    title: "People of Meatpacking: Judy Ong",
    slug: "people-of-meatpacking-judy-ong",
    description: "Meet the creative force behind the district's most iconic floral designs.",
    content: `In our latest installment of "People of Meatpacking," we sat down with Judy Ong, the visionary florist whose arrangements have graced the lobbies of the Gansevoort and the storefronts of Washington Street for over a decade.

"The District has an energy you can't find anywhere else," says Ong. "It's the collision of the industrial past and the high-fashion future. That tension inspires every bouquet I arrange."

Judy discusses her journey from a small pop-up on 13th Street to becoming a staple of the neighborhood's aesthetic identity.`,
    author: "Meatpacking BID",
    publishedDate: "05.15.2024",
    // Replace with local image
    heroImage: "/images/p1.jpg",
    tags: ["COMMUNITY", "INTERVIEW", "AAPIHM"],
  ...
  {
    id: "6",
    title: "Late Nights at The Standard",
    slug: "late-nights-standard",
    description: "Jazz, cocktails, and the best views in the city.",
    content: "Experience the skyline like never before. The Standard High Line introduces a new weekly jazz series featuring local legends and curated cocktails.",
    author: "The Standard",
